            ...
            <div className="projects-grid">
                ...
                <div class="project-card">
                    ...
                    <div class="project-links">
                        <a href="https://github.com/sahsahil1998/Mine-a-Database" target="_blank">Source Code</a>
                    </div>
                </div>
                {/* Project 4 */}
                <div class="project-card">
                    ...
                    <div class="project-links">
                        <a href="https://github.com/sahsahil1998/Design-Implement-a-RD" target="_blank">Source Code</a>
                    </div>
                </div>
                {/* Project 5 */}
                <div class="project-card">
                    ...
                    <div class="project-links">
                        <a href="https://github.com/sahsahil1998/Web-Crawler/tree/main/Project%202" target="_blank">Source Code</a>
                    </div>
                </div>
                {/* Project 6 */}
                <div class="project-card">
                    ...
                    <div class="project-links">
                        ...
                        <a href="https://github.com/sahsahil1998/Mastermind" target="_blank">Source Code</a>
                    </div>
                </div>
            </div>
        </section>
